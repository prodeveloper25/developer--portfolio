...
const Expertise = () => {
  ...
  return (
    <div className="bg-[#dbffd8]">
      <div className="mx-4">
        <div className="mt-4 max-w-screen-xl mx-auto lg:px-10 py-9 md:px-5 ">
          ...
          <div>
            <h2 className="lg:text-3xl lg:w-[520px] md:w-[420px] w-full md:text-2xl  text-xl  lg:mb-0 md:mb-0 mb-5">
              As a <span className="text-[#14a800]">Web Developer</span> I am
              good at using:
            </h2>
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-4 gap-4 grid-cols-3 lg:mb-0 md:mb-0 mb-10 lg:w-full md:w-full w-[310px] mx-auto">
                  {expertises.map((item) => (
                    <Tooltip
                      ...
                      style="dark"
                    >
                      <div className="lg:w-28 lg:h-28 md:w-20 md:h-w-20  bg-white lg:px-6 lg:py-6 md:px-4 md:py-3 w-16 h-16 px-2 py-2 shadow">
                        <img
                          className="lg:w-24 md:w-24 w-14 lg:hover:scale-110 duration-300"
                          src={item.image}
                          alt=""
                        />
                      </div>
