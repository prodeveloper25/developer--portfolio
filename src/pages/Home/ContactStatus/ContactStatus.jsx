...
const ContactStatus = () => {
  return (
    <div className="lg:mt-28 mx-4 md:mt-16 mt-10 lg:mb-28 md:mb-16 mb-12  lg:mx-14">
      <div
        className="lg:px-10 lg:py-16 md:py-16 md:px-4 px-4 py-6 lg:flex md:flex items-center shadow-2xl max-w-screen-xl mx-auto "
        style={{
      ...
      >
        ...
        <div className="lg:w-1/4 md:w-1/4 lg:mt-0 md:mt-0 mt-6">
          <Link to="/contact">
            <button className="bg-[#fc3a40] btnHoverEffects  flex gap-2 items-center text-white lg:px-6 lg:py-3 md:px-6 md:py-3 px-3 py-2 lg:text-lg lg:font-semibold duration-200 rounded lg:hover:scale-105 hover:bg-[#14a800] ">
