        ...
        <div className="lg:flex md:flex items-center lg:gap-40">
          <div className="lg:w-1/2 md:w-1/2 w-full">
            ...
            <a href="https://www.fiverr.com/pro_developer25" target="blank">
              <button className="bg-[#fc3a40] btnHoverEffects lg:hover:scale-105 flex gap-2 items-center lg:mt-16 text-white px-4 py-2 duration-300 rounded hover:bg-[#14a800] ">
